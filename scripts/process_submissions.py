...
def process_row(row: dict, drive, gh_repo) -> tuple[bool, str, list[str]]:
    ...
    validation_lines = [
        ...
        "- [ ] Tags — tags are relevant and properly normalised",
    ]
    if new_author:
        validation_lines += [
            "- [ ] Author — profile details (bio, occupation, links) are correct",
            "- [ ] Author URL — author slug is correct and readable",
            "- [ ] Author Photo — photo renders and looks right",
        ]
